...
const ButtonIcon = ({ data }) => {
    ...
    return (
        <div className="button-icon">
            <a href={data.links.download + '&force=true'} className="button-dowload" download target="_blank" rel="noopener noreferrer">
                <span>Dowload</span>
            </a>
            <div className="button-options-container">
                ...
                <Menu className="menu-options" ref={menu} data={data} />
            </div>
        </div>
    )
}
