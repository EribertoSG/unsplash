...
const PhotoDetail = ({ photo }) => {
    const separator = (numbers) => {
        ...
        return internationalNumberFormat.format(numbers)
    }
    ...
    return (
        <div className="detail">
            <div className="detail-header">
                <div className='user'>
                    <UserProfile userPhoto={photo.user.profile_image.medium} />
                    <Text text={photo.user.username} className="user-text-popup" />
                </div>
            ...
            <div className="detail-footer">
                <div className="detail-1">
                    <div className="detail-1__views">
                        <h3>Views</h3>
                        <span>{separator(photo.views)}</span>
                    </div>
                    <div className="detail-1__downloads">
                        <h3>Downloads</h3>
                        <span>{separator(photo.downloads)}</span>
                    </div>
                </div>
